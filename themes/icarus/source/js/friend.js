...
$(function () { //获取处理友链数据
    $.getJSON("../json_data/friend.json", function (data) {
        ...
        $('.links-content').append("<div class='friend-title-item'><br>Links<br><br><hr></div>");
        $.each(data, function (i, e) {
            var html = "<div class=\"friend-card-item\">";
            if (e.src == undefined) {
                html += "    <img class=\"ava\" src=\"/img/links/nopic.jpg\" title=\"图片链接不可用, 使用默认图片\">";
            } else {
        ...
        if (notValid.length > 0) {
            $('.links-content').append("<div class='friend-title-item'><br>异常的Links<br><br><hr></div></div>");
